...
public class GuitarMain {
    public static void main(String[] args) {
        ...
        inventory.addGuitar("G002", 5200, new GuitarSpec(Builder.GIBSON, "les paul", Type.ELECTRIC, 12, Wood.MAHOGANY, Wood.MAPLE));
        inventory.addGuitar("G003", 4300, new GuitarSpec(Builder.MARTIN, "d-28", Type.ACOUSTIC, 6, Wood.INDIAN_ROSEWOOD, Wood.SPRUCE));
        inventory.addGuitar("G004", 3900, new GuitarSpec(Builder.FENDER, "f310", Type.ACOUSTIC, 12, Wood.NATO, Wood.SPRUCE));
        inventory.addGuitar("G005", 6100, new GuitarSpec(Builder.OLSON, "sj", Type.ACOUSTIC, 6, Wood.CEDAR, Wood.BRAZILIAN_ROSEWOOD));
        inventory.addGuitar("G006", 4500, new GuitarSpec(Builder.MARTIN, "custom 24", Type.ELECTRIC, 6, Wood.MAHOGANY, Wood.MAPLE));
        inventory.addGuitar("G007", 3800, new GuitarSpec(Builder.COLLINGS, "om2h", Type.ACOUSTIC, 12, Wood.INDIAN_ROSEWOOD, Wood.SITKA));
        inventory.addGuitar("G008", 7200, new GuitarSpec(Builder.RYAN, "nightingale", Type.ACOUSTIC, 6, Wood.COCOBOLO, Wood.SPRUCE));
        inventory.addGuitar("G009", 5600, new GuitarSpec(Builder.FENDER, "telecaster", Type.ELECTRIC, 6, Wood.ASH, Wood.MAPLE));
                ...
                if (option == 1) {
                    ...
                    while (true) {
                        try {
                            ...
                            System.out.println("Invalid enum input: " + e.getMessage());
                        } catch (Exception e) {
